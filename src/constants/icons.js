...
export const loadIcons = async () => {
  ...
  // navigation
  ICONS.exitToApp12 = await MIcons.getImageSource('exit-to-app', 12, COLORS.lightGrey2)
  ...
  ICONS.checkBox20 = await MIcons.getImageSource('check-box', 20, COLORS.darkGrey2)
  ICONS.peopleOutline20 = await MIcons.getImageSource('people-outline', 20, COLORS.darkGrey2)

  // branding
  ICONS.logo = require('Ecd/src/assets/logo.png')
  /*
